...
namespace Project_01.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StuId,StuNameC,StuNameE,StuIdno,StuEmail,StuGender,StuBirthday,StuYear")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("StuId,StuNameC,StuNameE,StuIdno,StuEmail,StuGender,StuBirthday,StuYear")] Student student)
        {
            if (id != student.StuId)
            {
                return NotFound();
